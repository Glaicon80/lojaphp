...
<script>
    ...
    function novoCep() {
        ...
        window.location.replace("{$VOLTARCARRINHO}");
    }
...
<!-- começa  o container geral -->
    ...
    <div class="row" style="background-color:rgb(248, 249, 250);" id="row">
                ...
                <div class="bg-light" id="divQseraoculta" style="padding-left: 30px; padding-right: 30px;">
                    ...
                    <div class="py-5 text-center" >
                        <img class="d-block mx-auto mb-8"
                            src="{$MEDIA}/images/Logo_PagSeguro.png" alt="" width="300"
                            height="100">
                    ...
                    <div class="row">
                        <div class="col-md-4 order-md-2 mb-4">
                            ...
                            <ul class="list-group mb-3">
                             ...
                             {foreach from = $CARRINHO item = P} <!-- aqui vai pegar a lista de categorias ($CATEGORIAS) e cada categoria vai ser jogada em C uma por vez no loop-->
                                
                                    
                             <li class='list-group-item d-flex justify-content-between lh-condensed'><div><h6 class='my-0'>{$P.pro_nome}</h6><small class='text-muted'>Quantidade: {$P.pro_qtd}</small></div><span class='text-muted'>Unidade: {$P.pro_valor}</span></li>
                            ...
                            <input type="hidden" name="listarParaPix" id="listarParaPix" value="{$LISTAPARAPIX}"> <!-- esse input vai ser usado exclusivamente para o pix para listar todos os itens -->
       ...
       ?>
                    ...
                    <div class="container" id="bola">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 "></div>
                            <div class="col-md-4 ">
                                <form action="{$CLIENTEPEDIDO}" id="formPagamento1"
      ...
      <div class="col-md-2 bg-light" id="colunaEsquerda" >
        ...
        <div  id="categorias1">
          ...
          <div class="navbar-nav mr-auto">
            ...
            {foreach from = $CATEGORIAS item = C} <!-- aqui vai pegar a lista de categorias ($CATEGORIAS) e cada categoria vai ser jogada em C uma por vez no loop-->
             ...
             <a nav-link href="{$C.cate_link}" class="list-group-item nav-item" ><i class="fas fa-angle-right"></i> {$C.cate_nome}</a> 
        ...
        <script src="{$TEMA}/tema/js/qrcode.min.js" type="text/javascript"></script>
        <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js"></script>
        <script src="https://stc.pagseguro.uol.com.br/pagseguro/api/v2/checkout/pagseguro.directpayment.js"></script>
        <script src="{$TEMA}/tema/js/boleto3.js"></script>

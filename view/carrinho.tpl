...
if(cep1.trim()=="" && cep2.trim()==""){
    ...
    if ($("#frete_radio1").prop("checked") || $("#frete_radio2").prop("checked") || $("#frete_radio").prop("checked") ) {
         ...
         window.location.replace("http://localhost/lojaphp/pagamento");
...
margin-left: 0px;
    ...
    <div class="row">
        ...
        <div id="continuarComprando" class="col-md-12 text-right">
            <a href="{$PAG_PRODUTOS}" class="btn btn-info" title="">Continuar comprando</a>
        </div>
...
<!-- botao visivel para desktop-->
    ...
    <section id="tbPequena" class="row">
        ...
        <table class="table table-borderless">
            ...
            {foreach from=$PRO item=P}
                ...
                <th scope="row"></th> 
                <td> <img src="{$P.pro_img}" class="img-thumbnail"  alt="{$P.pro_nome}"> </td>
                </tr>
                <tr class="table-info">
   ...
   <!-- tabela visivel no mobile-->
    ...
    <input type="hidden" name="peso_frete" id="peso_frete" value="{$PESO}" class="form-control "> 
    <input type="hidden" name="comprimento_frete" id="comprimento_frete" value="{$COMPRIMENTO}" class="form-control ">
    <input type="hidden" name="largura_frete" id="largura_frete" value="{$LARGURA}" class="form-control "> 
    <input type="hidden" name="altura_frete" id="altura_frete" value="{$ALTURA}" class="form-control ">     

...
class Sistema {
    ...
    */
     ...
     */
     ...
     static function janelaModal($texto){ //vc pode clicar fora que ela desaparece

    

     echo '<input type="hidden" id="itexto" value="'.$texto.'">';
     ...
     echo '<script>';
     echo '$(document).ready(function(){';
     echo '$("#alertaMensagem1").text($("#itexto").val())';
     echo'})';
     echo'</script>';
    ...
    static function janelaModalEstatica($texto){ // ela só vai desaparecer se vc clicar no botao, não desaparece clicando fora

     echo '<input type="hidden" id="itexto" value="'.$texto.'">';
     echo '<script>';
     echo   '$(document).ready(function(){';
     echo   '$("#modalAlerta1").modal( {backdrop: "static",keyboard: false})';
     echo   '})';
     echo '</script>';
